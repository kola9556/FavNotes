  ...
  <div className="App">
    <header className="App-header">
      ...
      >
        ...
        typeerrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrgggg and scrambled it to make a
        typedssssssssssssssssssssssssssssssv ds specimen book. It has survived not only
        fivedfffffffffffffffffffffffffffffffff centuries, but also the leap into electronic
        ...
        sometimes by accident, sometimes on purpose (injected humour and the like). Where does it
        come from? Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
        ...
        accompanied by English versions from the 1914 translation by H. Rackham. Where can I get
        some? There are many variations of passages of Lorem Ipsum available, but the majority have
        ...
        The generated Lorem Ipsum is therefore a
      </a>
    </header>
  </div>
);
